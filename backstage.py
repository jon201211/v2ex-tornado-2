    ...
    def get(self):
        ...
        if (member):
            if (member.level == 0):
                ...
                t=self.get_template(path,'backstage_home.html')
...
class BackstageNewMinisiteHandler(BaseHandler):
    def get(self):
        ...
        if (member):
            if (member.level == 0):    
                path = os.path.join(os.path.dirname(__file__), 'tpl', 'desktop')
                t=self.get_template(path,'backstage_new_minisite.html')
                self.finish(t.render(template_values))
            else:
                self.redirect('/')
        else:
        ...
        if (member):
            if (member.level == 0):
                ...
                minisite_name_error_messages = ['',
                    ...
                    u'抱歉这个站点名已经存在了']
                minisite_name = self.request.arguments['name'][0].strip().lower()
                if (len(minisite_name) == 0):
                    ...
                    if (len(minisite_name) > 32):
                        ...
                        if (re.search('^[a-zA-Z0-9\-\_]+$', minisite_name)):
                            ...
                            q = Minisite.selectBy(name=minisite_name.lower())
                            if (len(list(q)) > 0):
                                errors = errors + 1
                ...
                minisite_title = self.request.arguments['title'][0].strip()
                ...
                minisite_description = self.request.arguments['description'][0].strip()
                ...
                if (errors == 0):
                    ...
                    q = Counter.selectBy(name='minisite.max')
                    if (q.count() == 1):
                        counter = q[0]
                    ...
                    minisite.created = time
                    minisite.last_modified = time
                    minisite.sync()
                    counter.sync()
        ...
        if (member):
            if (member.level == 0):
                ...
                if minisite is not False:
                    ...
                    q = Page.selectBy(minisite=minisite, orderBy='weight')
        ...
        if (member):
            if (member.level == 0):
                ...
                if minisite is not False:
                    ...
                    path = os.path.join(os.path.dirname(__file__), 'tpl', 'desktop')
                    t=self.get_template(path,'backstage_new_page.html')
                    self.finish(t.render(template_values))
                else:
                    self.redirect('/backstage')
            else:
            ...
            if (member.level == 0):
                ...
                if minisite is False:
                    ...
                    page_name_error_messages = ['',
                        ...
                        u'抱歉这个页面名已经存在了']
                    page_name = self.request.arguments['name'][0].strip().lower()
                    if (len(page_name) == 0):
                        errors = errors + 1
                        page_name_error = 1
                    else:
                        if (len(page_name) > 64):
                            ...
                            if (re.search('^[a-zA-Z0-9\-\_\.]+$', page_name)):
                                ...
                                q = Page.selectBy(name=page_name.lower())
                                if (q.count() > 0):
                    ...
                    page_t = self.request.arguments['t'][0].strip()
                    if (len(page_t) == 0):
                        errors = errors + 1
                        page_t_error = 1
                    else:
                    ...
                    page_content = self.request.arguments['content'][0].strip()
                    ...
                    # Verification: mode
                    page_mode = 0
                    page_mode = self.request.arguments['mode'][0].strip()
                    if page_mode == '1':
                        page_mode = 1
                    else:
                        page_mode = 0
                    # Verification: content_type
                    page_content_type = self.request.arguments['content_type'][0].strip()
                    ...
                    # Verification: weight
                    page_weight = self.request.arguments['weight'][0].strip()
                    if (len(page_content_type) == 0):
                        page_content_type = 0
                    else:
                    ...
                    if (errors == 0):
                        ...
                        q = Counter.selectBy(name='page.max')
                        if (q.count() == 1):
                            counter = q[0]
                            counter.value = counter.value + 1
                        else:
                        ...
                        q2 = Counter.selectBy(name='page.total')
                        if (q2.count() == 1):
                            counter2 = q[0]
                        ...
                        if page_mode == 1:
                            ...
                            c = {"site" : site, "minisite" : page.minisite, "page" : page}
                            output = t.render(c)
...
class BackstageRemoveMinisiteHandler(BaseHandler):
    def get(self, minisite_key):
        member = CheckAuth(self)
        if member:
            if member.level == 0:
                minisite = Minisite.get(minisite_key)
                if minisite:
                    # Delete all contents
                    #pages = db.GqlQuery("SELECT * FROM Page WHERE minisite = :1", minisite)
                    pages = Page.selectBy(minisite=minisite)
                    for page in pages:
        ...
        if (member):
            if (member.level == 0):
                ...
                if page:
                    ...
                    path = os.path.join(os.path.dirname(__file__), 'tpl', 'desktop')
                    t=self.get_template(path,'backstage_page.html')
                    self.finish(t.render(template_values))
                else:
                    self.redirect('/backstage')
            else:
                    ...
                    if (len(page_name) == 0):
                        ...
                        if (len(page_name) > 64):
                            ...
                            if (re.search('^[a-zA-Z0-9\-\_\.]+$', page_name)):
                                ...
                                q = Page.selectBy(name=page_name.lower(),minisite=page.minisite)
                                if (q.count() > 0):
                                    if q[0].num != page.num:
                                        errors = errors + 1
                                        page_name_error = 4
...
class BackstageRemovePageHandler(BaseHandler):
    def get(self, page_key):
        member = CheckAuth(self)
        if member:
            if member.level == 0:
...
class BackstageNewSectionHandler(BaseHandler):
    def get(self):
        ...
        if (member):
            if (member.level == 0):    
                path = os.path.join(os.path.dirname(__file__), 'tpl', 'mobile')
                t=self.get_template(path,'backstage_new_section.html')
                self.finish(t.render(template_values))
            else:
                self.redirect('/')
        else:
        ...
        if (member):
            if (member.level == 0):
                ...
                section_name_error_messages = ['',
                    ...
                    u'抱歉这个区域名已经存在了']
                section_name = self.request.arguments['name'][0].strip().lower()
                if (len(section_name) == 0):
                    ...
                    if (len(section_name) > 32):
                        ...
                        if (re.search('^[a-zA-Z0-9\-\_]+$', section_name)):
                            ...
                            q = Section.selectBy(name=section_name.lower())
                            if (q.count() > 0):
                                errors = errors + 1
                ...
                section_title = self.request.arguments['title'][0].strip()
                ...
                section_title_alternative = self.request.arguments['title_alternative'][0].strip()
                ...
                if (errors == 0):
                    ...
                    q = Counter.selectBy(name='section.max')
                    if (q.count() == 1):
                        counter = q[0]
                        counter.value = counter.value + 1
                    else:
    ...
    def get(self, section_name):
        ...
        if (member):
            if (member.level == 0):
                ...
                q = Section.selectBy(name=section_name)
                section = False
                if (q.count() == 1):
                    section = q[0]
                ...
                if (section):
                    ...
                    q2 = Node.selectBy(section_num=section.num, orderBy='-last_modified').limit(10)
                ...
                if browser['ios']:
                    ...
                    path = os.path.join(os.path.dirname(__file__), 'tpl', 'desktop')
                t=self.get_template(path,'backstage_section.html')
                self.finish(t.render(template_values))
            else:
                self.redirect('/')
        else:
        ...
        if member:
            if member.level == 0:
                ...
                if section is not False:
                    ...
                    section_header = self.request.arguments['header'][0].strip()
                    ...
                    section_footer = self.request.arguments['footer'][0].strip()
    ...
    def get(self, section_name):
        ...
        if (member):
            if (member.level == 0):
                ...
                path = os.path.join(os.path.dirname(__file__), 'tpl', 'mobile')
                t=self.get_template(path,'backstage_new_node.html')
                self.finish(t.render(template_values))
            else:
                self.redirect('/')
        else:
        ...
        if (member):
            if (member.level == 0):        
                ...
                node_name_error_messages = ['',
                    ...
                    u'抱歉这个节点名已经存在了']
                node_name = self.request.arguments['name'][0].strip().lower()
                if (len(node_name) == 0):
                    errors = errors + 1
                    node_name_error = 1
                else:
                    if (len(node_name) > 32):
                        ...
                        if (re.search('^[a-zA-Z0-9\-\_]+$', node_name)):
                            ...
                            q = Node.selectBy(name=node_name.lower())
                            if (q.count() > 0):
                                errors = errors + 1
                                node_name_error = 4
                        else:
                ...
                node_title = self.request.arguments['title'][0].strip()
                if (len(node_title) == 0):
                    errors = errors + 1
                    node_title_error = 1
                else:
                ...
                node_title_alternative = self.request.arguments['title_alternative'][0].strip()
                ...
                if (errors == 0):
                    ...
                    q = Counter.selectBy(name='node.max')
                    if (q.count() == 1):
                        counter = q[0]
                        counter.value = counter.value + 1
                    else:
    ...
    def get(self, node_name):
        ...
        if (member):
            if (member.level == 0):
                ...
                q =Node.selectBy(name=node_name)
                if (q.count() == 1):
                    node = q[0]
                ...
                if browser['ios']:
                    ...
                    path = os.path.join(os.path.dirname(__file__), 'tpl', 'desktop')
                t=self.get_template(path,'backstage_node.html')
                self.finish(t.render(template_values))
            else:
                self.redirect('/')
        else:
    ...
    def post(self, node_name):
        ...
        if (member):
            if (member.level == 0):        
                ...
                q2 = Section.selectBy(num=q[0].section_num)
                if (q2.count() == 1):
                    section = q2[0]
                ...
                if (len(node_name) == 0):
                    ...
                    if (len(node_name) > 32):
                        ...
                        if (re.search('^[a-zA-Z0-9\-\_]+$', node_name)):
                            ...
                            q = Node.selectBy(name = node_name.lower(), num=node.num)
                            if (q.count() > 0):
                                errors = errors + 1
                                node_name_error = 4
                        else:
    ...
    def post(self, node_name):
        if self.member:
            if self.member.level == 0:
                ...
                s.write(avatar)
                image = Image.open(s)
                avatar_73 = image.resize( 73, 73)
                avatar_48 = image.resize( 48, 48)
                avatar_24 = image.resize( 24, 24)
                # Large 73x73
                #q1 = db.GqlQuery("SELECT * FROM Avatar WHERE name = :1", 'node_' + str(node.num) + '_large')
                q1 = Avatar.selectBy(name='node_' + str(node.num) + '_large')
                if (q1.count() == 1):
                    avatar_large = q1[0]
                ...
                q2 = Avatar.selectBy(name='node_' + str(node.num) + '_normal')
                if (q2.count() == 1):
                    avatar_normal = q2[0]
                ...
                q3 = Avatar.selectBy(name='node_' + str(node.num) + '_mini')
                if (q3.count() == 1):
                    avatar_mini = q3[0]
...
class BackstageRemoveReplyHandler(BaseHandler):
        ...
        if (member):
            if (member.level == 0) and (str(member.created_ts) == str(t)):
                ...
                if reply:
                    ...
                    q = Reply.selectBy(topic=topic)
                    topic.replies = len(list(q))
                    if (topic.replies == 0):
...
class BackstageTidyTopicHandler(BaseHandler):
        ...
        if (member):
            if (member.level == 0):
                ...
                if (q.count() == 1):
                    ...
                    q2 = Member.selectBy(num=topic.member_num)
                    member = q2[0]
                    topic.member = member
                    #q3 = db.GqlQuery("SELECT * FROM Node WHERE num = :1", topic.node_num)
                    q3 = Node.selectBy(num=topic.node_num)
                    node = q3[0]
                    topic.node = node
                    topic.sync()
                    store.commit()  #jon add
...
class BackstageDeactivateUserHandler(BaseHandler):
    def get(self, key):
        member = CheckAuth(self)
        t = self.request.arguments['t'][0]
        if member:
        ...
        if member:
            ...
            if can_move:
                ...
                if topic is not None:
                    ...
                    path = os.path.join(os.path.dirname(__file__), 'tpl', 'desktop')
                    t=self.get_template(path,'backstage_move_topic.html')
                    self.finish(t.render(template_values))
                else:
                    self.redirect('/')
            else:
        ...
        if member:
            ...
            if can_move:
                ...
                if topic is not None:
                    ...
                    template_values['node'] = node
                    template_values['system_version'] = SYSTEM_VERSION
                    destination = self.request.arguments['destination'][0]
                    if destination is not None:
                        node_new = GetKindByName('Node', destination)
                        if node_new is not False:
                            node_new = Node.get(node_new.id)
                            node_old = topic.node
    ...
    def get(self):
        ...
        if member:
            if member.level == 0:
                ...
                template_values['themes'] = themes
                path = os.path.join(os.path.dirname(__file__), 'tpl', 'desktop')
                t=self.get_template(path,'backstage_site.html')
                self.finish(t.render(template_values))
        else:
            self.redirect('/')
    ...
    def post(self):
        ...
        if member:
            if member.level == 0:
                ...
                site_title = self.request.arguments['title'][0].strip()
                if (len(site_title) == 0):
                    errors = errors + 1
                    site_title_error = 1    
                else:
                ...
                site_slogan = self.request.arguments['slogan'][0].strip()
                ...
                site_domain = self.request.arguments['domain'][0].strip()
                ...
                site_description = self.request.arguments['description'][0].strip()
                ...
                site_analytics = self.request.arguments['analytics'][0].strip()
                ...
                site_l10n = self.request.arguments['l10n'][0].strip()
                ...
                site_home_categories = self.request.arguments['home_categories'][0].strip()
                ...
                site_topic_view_level = self.request.arguments['topic_view_level'][0]
                try:
                ...
                site_topic_create_level = self.request.arguments['topic_create_level'][0]
                try:
                ...
                site_topic_reply_level = self.request.arguments['topic_reply_level'][0]
                try:
                ...
                # Verification: meta
                site_meta = self.request.arguments['meta'][0]
                template_values['site_meta'] = site_meta
                # Verification: home_top
                site_home_top = self.request.arguments['home_top'][0]
                template_values['site_home_top'] = site_home_top
                # Verification: theme
                site_theme = self.request.arguments['theme'][0]
                themes = os.listdir(os.path.join(os.path.dirname(__file__), 'tpl', 'themes'))
                template_values['themes'] = themes
                ...
                site_data_migration_mode = self.request.arguments['data_migration_mode'][0]
    ...
    def get(self):
        ...
        if member:
            if member.level == 0:
                ...
                template_values['system_version'] = SYSTEM_VERSION
                path = os.path.join(os.path.dirname(__file__), 'tpl', 'desktop')
                t=self.get_template(path,'backstage_topic.html')
                self.finish(t.render(template_values))
        else:
            self.redirect('/')
    ...
    def post(self):
        ...
        if member:
            if member.level == 0:
                ...
                site_use_topic_types = self.request.arguments['use_topic_types'][0].strip()
                ...
                site_topic_types = self.request.arguments['topic_types'][0].strip()
                if errors == 0:
                    if site_use_topic_types == '1':
...
class BackstageRemoveMemcacheHandler(BaseHandler):
    def post(self):
        member = CheckAuth(self)
        if member:
            if member.level == 0:
                mc = self.request.arguments['mc'][0]
                if mc is not None:
                    memcache.delete(mc)
        self.redirect('/backstage')
    ...
    def get(self, member_username):
        ...
        if member:
            if member.level == 0:
                ...
                q = Member.selectBy(username_lower=member_username_lower)
                if (q.count() == 1):
                    one = q[0]
                    ...
                    template_values['latest_members'] = Member.select(orderBy='-created').limit(5)
                    path = os.path.join(os.path.dirname(__file__), 'tpl', 'desktop')
                    t=self.get_template(path,'backstage_member.html')
                    self.finish(t.render(template_values))
                else:
                    self.redirect('/backstage')
            ...
            if member.level == 0:
                ...
                if (q.count() == 1):
                    ...
                    one_username_error_messages = ['',
                        ...
                        l10n.username_taken]
                    one_username = self.request.arguments['username'][0].strip()
                        ...
                        if (len(one_username) > 32):
                            ...
                            if (len(one_username) < 3):
                                ...
                                if (re.search('^[a-zA-Z0-9\_]+$', one_username)):
                                    #q = db.GqlQuery('SELECT * FROM Member WHERE username_lower = :1 AND num != :2000', one_username.lower(), one.num)
                                    q = Member.select(AND (Member.q.username_lower==one_username.lower(), Member.q.num!=one.num ))
                                    if (q.count() > 0):
                                        errors = errors + 1
                    ...
                    one_email_error_messages = ['',
                        ...
                        u'输入的电子邮件地址不符合规则',
                        u'这个电子邮件地址已经有人注册过了']
                    one_email = self.request.arguments['email'][0].strip()
                    if (len(one_email) == 0):
                        errors = errors + 1
                        one_email_error = 1
                    else:
                        if (len(one_email) > 32):
                            ...
                            if (p.search(one_email)):
                                ...
                                q = Member.select(AND(Member.q.email==one_email.lower(), Member.q.num != one.num))
                                if (q.count() > 0):
                                    errors = errors + 1
                                    one_email_error = 4
                            else:
                    ...
                    # Verification: avatar
                    one_avatar_large_url = self.request.arguments['avatar_large_url'][0]
                    template_values['one_avatar_large_url'] = one_avatar_large_url
                    one_avatar_normal_url = self.request.arguments['avatar_normal_url'][0]
                    template_values['one_avatar_normal_url'] = one_avatar_normal_url
                    one_avatar_mini_url = self.request.arguments['avatar_mini_url'][0]
                    template_values['one_avatar_mini_url'] = one_avatar_mini_url
                    # Verification: bio
                    one_bio = self.request.arguments['bio'][0]
                    template_values['one_bio'] = one_bio
                    # Verification: level
                    one_level = self.request.arguments['level'][0]
                    try:
...
class BackstageMembersHandler(BaseHandler):
    def get(self):
        ...
        if member:
            if member.level == 0:
                template_values['member'] = member
                template_values['one'] = member #jon
                ...
                q = Member.select(orderBy='-created')[page_start:page_size]
